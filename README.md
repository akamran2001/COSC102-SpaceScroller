...
2)Fuel -> If the user hits a fuel object their health goes up.
3)Portal -> If the user hits a portal they're teleported to a different random location on the map.
4)Hammer,Wrench,Drill,Plyer,Srewdriver -> The user gains points when they collect these tools. If the collect the necessary amount indicated at the bottom of the screen, they win the game.
...
rocket.gif -> https://cdn130.picsart.com/300019132101211.png?type=webp&to=min&r=1024
(other variations of the rocket image are edits of this image)
